...
<section class="text-2 contain">
  ...
  <p>We provide light-weight client libraries to easily interface with our resources. These are currently availble in Node, Ruby, PHP. More languages will be added.</p>
