        ...
        _scrollTo: function(elem) {
            ...
            $("html, body").promise().done(function() {
                ...
                $("html, body").animate({
                    ...
                    "scrollTop": $('div[data-unique="' + elem.attr("data-unique") + '"]').next().offset().top - ($.isFunction(scrollTo) ? scrollTo.call() : scrollTo) - 80 + "px"
...
(function(window) {
  ...
  window.jsonHighlight = function(obj) {
    ...
    return json.replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g, function (match) {
        ...
        if (cls === 'key') {
          return '<span class="' + cls + '">' + match.replace(':', '') + '</span><span>:</span>';
        }
  ...
  window.data.analytics = {
    ...
    units: {
      ...
      timeSeries: {
        "_links": {
          "self": {
            "href": "https://api.vhx.tv/analytics?type=units&by=day&from=2013-07-19&to=2013-07-20"
          }
        },
        "to": "2013-07-20",
        "from": "2013-07-19",
